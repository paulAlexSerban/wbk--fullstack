...
import * as reducerFunctions from './counter.reducer.function';
import { type CounterState, type CounterReducers } from './counter';
...
const counterReducer: CounterReducers = {
    [COUNTER_ACTIONS.INCREMENT]: reducerFunctions.increment,
    [COUNTER_ACTIONS.DECREMENT]: reducerFunctions.decrement,
    [COUNTER_ACTIONS.INCREASE]: reducerFunctions.increase,
    [COUNTER_ACTIONS.DECREASE]: reducerFunctions.decrease,
    [COUNTER_ACTIONS.TOGGLE]: reducerFunctions.toggle,
};
