...
SERVER_NAME = os.getenv("PGADMIN_CONFIG_SERVER_NAME", "pgAdmin 4")
...
DEFAULT_USERNAME = os.getenv("PGADMIN_CONFIG_DEFAULT_USERNAME", "admin@example.com")
DEFAULT_PASSWORD = os.getenv("PGADMIN_CONFIG_DEFAULT_PASSWORD", "password")
